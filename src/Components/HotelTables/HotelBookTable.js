...
const HotelBookTable = ({ color, data, dataRecord,
  Listing = () => { } }) => {
                      ...
                      <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                        <div className="flex items-center">
                          ...
                          <i className="fa fa-fw fa-eye"
                            data-tip="View"
                            // onClick={() => navigate('/bookings-view-hotel/' + item.booking_id)}
                            onClick={() => navigate('/view_booking/' + item.booking_id,{state:{bookid:item.booking_id}})}
                            style={{
                              float: "right",
                          ...
                          {/* <i className="fa fa-fw fa-pen"
                            onClick={() => navigate('/hotel-booking-update/' + item.booking_id)}
                            data-tip="Update"
                            style={{
                              float: "right",
                              color: "#12C412",
