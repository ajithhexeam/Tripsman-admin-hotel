    ...
    confirmAlert({
        ...
        buttons: [
            ...
            onClick: async () => {
                setLoading(true)  
                await axios({
                    url: REACT_APP_SERVER_URL+"/api/HotelVendorBooking/CancelHotelVendorBooking?BookingId="+bookid,
                    method: 'post',
                    headers: {
                        "Authorization" : `Bearer ${token}`,
                        "HotelId":`${HotelId}`
                                        ...
                                        <div className="flex-auto px-4 lg:px-10 py-10 pt-2">
                                            ...
                                            <form>
                                                ...
                                                <div className="relative w-full  mb-3 px-2" id="buttonview">
                                                    <div className="text-center  lg:w-3/12  mt-2 px-2">
                                                        <button
...
export default HotelViewBooking;
